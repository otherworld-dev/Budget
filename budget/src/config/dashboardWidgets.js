...
export const DASHBOARD_WIDGETS = {
    ...
    widgets: {
        ...
        spendingChart: { id: 'spending-chart-card', name: t('budget', 'Spending by Category'), defaultSize: 'm', allowedSizes: ['s', 'm', 'l'], defaultVisible: true, settingsSchema: { dateRange: true, shortRange: true, budgetPeriodRange: true, accountSelector: true, excludeShared: true, showLegend: true, chartType: ['doughnut', 'bar'], topLevelOnly: true } },
        ...
        // Phase 1 - Quick Wins (use existing data)
        topCategories: { id: 'top-categories-card', name: t('budget', 'Top Spending Categories'), defaultSize: 's', allowedSizes: ['xs', 's', 'm', 'l'], defaultVisible: false, category: 'insights', settingsSchema: { dateRange: true, shortRange: true, budgetPeriodRange: true, accountSelector: true, excludeShared: true, topLevelOnly: true } },
        ...
        largeTransactions: { id: 'large-transactions-card', name: t('budget', 'Large Transactions'), defaultSize: 'hero', defaultVisible: false, category: 'transactions', settingsSchema: { dateRange: true, shortRange: true, accountSelector: true, excludeShared: true, rowCount: { min: 3, max: 20, default: 5 } } },
        weeklyTrend: { id: 'weekly-trend-card', name: t('budget', 'Weekly Spending'), defaultSize: 's', allowedSizes: ['s', 'm', 'l'], defaultVisible: false, category: 'insights', settingsSchema: { dateRange: true, shortRange: true, accountSelector: true, excludeShared: true, showLegend: true } },
        ...
        categoryTrends: { id: 'category-trends-card', name: t('budget', 'Category Trends'), defaultSize: 'hero', defaultVisible: false, category: 'insights', settingsSchema: { dateRange: true, shortRange: true, accountSelector: true, excludeShared: true, showLegend: true, topLevelOnly: true } },
