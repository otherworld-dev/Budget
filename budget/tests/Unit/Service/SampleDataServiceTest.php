...
class SampleDataServiceTest extends TestCase {
	...
	private function service(string $today = '2026-09-23'): SampleDataService {
		return new class($today, $this->settings, $this->accounts, $this->categories, $this->transactions, $this->createMock(TransactionSplitService::class), $this->createMock(TagSetService::class), $this->createMock(TransactionTagService::class), $this->createMock(BillService::class), $this->createMock(RecurringIncomeService::class), $this->goals, $this->createMock(PensionService::class), $this->createMock(AssetService::class), $this->createMock(NetWorthService::class), $this->rates, $this->createMock(SharedExpenseService::class), $this->factoryReset, ) extends SampleDataService {
