...
### Added
- **Export all your import rules to a file.** A new **Export** button on the Rules page downloads every rule you own as a single JSON file — a lightweight backup or a way to move your whole rule set to another instance, without doing a full data export. Rules shared with you are left out (they belong to their owner). Rules remain part of the full data export too ([#318](https://github.com/otherworld-dev/Budget/issues/318))
